...
/*
    author:  minguin
    Date : 2021.10.14
    Comment : 작성해둔 modal 연결하기 위해 import 추가
    (#46) import ExportModalOnce from 'components/export-once/export-once';
*/
...
class CVATApplication extends React.PureComponent<CVATAppProps & RouteComponentProps> {
    ...
    public render(): JSX.Element {
        ...
        /*
            author : minguin
            Date : 2021. 10. 14
            Comment : history push 해서 페이지 연결하는 소스 코드
            (#348) 추가 : <Route exact path='/cloudstorages' component={CloudStoragesPageComponent} />
        */
        if (readyForRender) {
